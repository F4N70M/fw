...
<!--                <a href="--><?//= APP_PREFIX; ?><!--/new-access" class="btn">добавить доступ</a>-->
                <a href="<?= APP_PREFIX; ?>/new-access-<?=$this->data['id'];?>" class="btn popup-link--">добавить доступ</a>
            </div>
            <div class="part-min">
                <h1>Доступы</h1>
            </div>
                                ...
                                switch ($access['class']) {
                                    case "provider":
                                        ...
                                        <div class="d-g gg-1 jc-sb gtc-2" sty-le="grid-template-columns: auto auto">
                                            <div>Тип</div><div class="fw-b"><?=$types[$access['class']];?></div>
                                    ...
                                    case "sql":
                                        ...
                                        <div class="d-g gg-1 jc-sb gtc-2" sty-le="grid-template-columns: auto auto">
                                            ...
                                            <div>Логин</div><div class="copyToClipboard"><?=$access['login'];?></div>
                                            <div>Пароль</div><div class="copyToClipboard"><?=$access['password'];?></div>
                                            <div>База данных</div><div class="copyToClipboard"><?=$access['db_name'];?></div>
                                        </div>
                                        <?php
                                        break;
                                    case "mail":
