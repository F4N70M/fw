...
//        debug($messageFiles);
        ...
        {
            $tmpFile = $this->Fw->File($fileId['id']);
                                ...
                                <div class="mv-1">
                                    <div class="d-g gaf-c jc-sb gg-1">
                                        ...
                                        <div class="d-g gaf-c gg-1">
                                            <div>
                                                <span class="p-05 bg-2"><?=$states[$task['state']];?></span>
                                            </div>
                                            <div>
                                            ...
                                            <div class="d-g">
                                                ...
                                                <div class="d-g gtc-2">
                                                    <div>
                                                        ...
                                                        <label for="file" class="w-100p">Добавить файлы</label>
                                                    </div>
                    ...
                    <div class="mv-1">
                        <?php foreach ($statuses as $key => $value): ?>
                            <form method="post" class="d-ib">
                                ...
                                <button type="submit" <?=($key == $task['status']) ? 'disabled' : '';?> class="bg-2"><?=$value;?></button>
                            </form>
                        <?php endforeach; ?>
                    </div>
